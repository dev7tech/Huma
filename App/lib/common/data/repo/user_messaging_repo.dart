...
class UserMessagingRepo {
  ...
  //       await db.collection('/Users/uid/Matches').orderBy('timestamp', descending: true).get();
  //   List<UserModel> matches = [];
  //   if (querySnapshot.docs.isNotEmpty) {
  //     for (DocumentSnapshot documentSnapshot in querySnapshot.docs) {
  //       DocumentSnapshot doc = await docRef.doc(documentSnapshot['Matches']).get();
  //       if (doc.exists) {
  //         UserModel tempuser = UserModel.fromDocument(doc);
  //         tempuser.distanceBW = calculateDistance(currentUser.latitude, currentUser.longitude,
  //                 tempuser.latitude, tempuser.longitude)
  //             .round();
  ...
  // static Future<List<BlockUserModel>> getBlockUserList(UserModel currentUser, int perPage) async {
  ...
  //   if (querySnapshot.docs.isNotEmpty) {
  //     for (DocumentSnapshot documentSnapshot in querySnapshot.docs) {
  //       DocumentSnapshot userDoc = await docRef.doc(documentSnapshot['blockedID']).get();
  //       if (userDoc.exists) {
  ...
  // static Future<List<BlockUserModel>> loadMoreBlockUsers(UserModel currentUser, int perPage,
  ...
  // static addTexttoDb(
  //     CollectionReference chatReference, String text, String chatId, String senderId, secondId) {
  //   chatReference.add({
  //     'type': 'Msg',
  //     'text': text,
  //     'sender_id': senderId,
  ...
  // static void sendImage(String? messageText, String? imageUrl, CollectionReference chatReference,
