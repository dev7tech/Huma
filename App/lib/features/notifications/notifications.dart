...
class NotificationsState extends State<Notifications> {
  ...
  void initState() {
    ...
    // notificationReference = db.collection("Users").doc(currentUser!.id).collection('Matches');
                          ...
                          child: Container(
                            ...
                            child: ListTile(
                              ...
                              onTap: () async {
                                ...
                                //     await db.collection("Users").doc(doc.get("Matches")).get();
                                // if (userdoc.exists) {
                                //   Navigator.pop(context);
                                //   UserModel tempuser = UserModel.fromDocument(userdoc);
                                //   tempuser.distanceBW = UserSearchRepo.calculateDistance(
                                ...
                                //     builder: (context) {
                                //       if (!doc.get("isRead")) {
                                //         PaginationRepo.updateNotification(currentUser!, doc);
                                //       }
                                //       return Container();
                                //       // return Info(tempuser, currentUser!, false);
                                //     },
                                //   );
                                // } else {
                                //   Navigator.pop(context);
