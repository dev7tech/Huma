                    ...
                    child: Container(
                      ...
                      child: ClipRRect(
                        ...
                        child: Container(
                          color: Colors.white,
                          child: CustomCNImage(
                            imageUrl: widget.users[itemIndex].profileUrl,
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
                        ...
                        children: [
                          ListTile(
                            title: Row(
                              children: [
                                Text(
                                  widget.users[itemIndex].profileInfo,
                                ...
                                // widget.users[itemIndex].editInfo!['showOnProfile'] ?? false
                                //     ? GenderSign(
                                //         gender: widget.users[itemIndex].userGender!,
