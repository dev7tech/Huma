...
class SettingPageState extends State<SettingPage> {
              ...
              actions: <Widget>[
                TextButton(
                  onPressed: () {
                    ...
                    debugPrint("change---$changeValues");
                  },
                  child: Text(
                    "Close".tr().toString(),
                  ...
                  builder: (context, state) {
                    ...
                    return TextButton(
                      onPressed: () {
                        ...
                        debugPrint("not empty changesvalue");
  ...
  Widget build(BuildContext context) {
    ...
    debugPrint(widget.currentUser.toString());
    debugPrint(
        "my phone number is ${widget.currentUser.phoneNumber.toString()}");
    return BlocListener<UserfilterBloc, UserfilterState>(
      listener: (context, state) {
        if (state is UserFilterUpdationFailed) {
          ...
          debugPrint("filter succesfully applied ....".tr().toString());
