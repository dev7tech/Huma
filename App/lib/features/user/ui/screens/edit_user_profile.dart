...
class EditProfileState extends State<EditProfile> {
  ...
  void initState() {
    super.initState();
    debugPrint('---------------------${widget.currentUser.phoneNumber}');
  ...
  Future<bool> _onWillPop() async {
    ...
    if (currentstate == UpdatingUser()) {
      debugPrint("coming under updating state");
      return false;
    }
    ...
    return BlocListener<UserBloc, UserStates>(
      listener: (context, state) {
        if (state is UpdatingUser) {
          ...
          debugPrint("updated succesfully user ....".tr().toString());
          _madeChanges.value = false;
          editInfo.clear();
                                          ...
                                          children: <Widget>[
                                            ...
                                            Switch(
                                                ...
                                                onChanged: (value) {
                                                  ...
                                                  _madeChanges.value = true;
                                                  debugPrint(
                                                      "updated distance visible details ....$editInfo");
                                                  setState(() {
                                          ...
                                          return BlocBuilder<UserBloc,
                                            ...
                                            return CustomButton(
                                                ...
                                                onTap: () async {
                                                  ...
                                                  if (editInfo.isNotEmpty) {
                                                    debugPrint(
                                                        "updated all detais 1....$editInfo");

                                                    debugPrint(
                                                        "updated all detais without image ....$editInfo");
  ...
  void _deletePicture(int index) async {
    if (widget.currentUser.imageUrl![index] != null) {
      // try {
      //   Reference ref = FirebaseStorage.instance.refFromURL(widget.currentUser.imageUrl![index]);
    ...
    // await firebaseFireStoreInstance.collection("Users").doc(widget.currentUser.id).set({
