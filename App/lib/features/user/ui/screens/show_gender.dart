        ...
        children: <Widget>[
                  ...
                  child: SizedBox(
                    ...
                    child: Center(
                        child: Text("MEN".tr().toString(),
                            style: TextStyle(
                                fontSize: 20,
                                color: men ? primaryColor : secondaryColor,
                    ...
                    child: SizedBox(
                      ...
                      child: Center(
                          child: Text("WOMEN".tr().toString(),
                              style: TextStyle(
                                  fontSize: 20,
                                  color: women ? primaryColor : secondaryColor,
                                  fontWeight: FontWeight.bold))),
                    ),
                    onPressed: () {
                      setState(() {
                  ...
                  child: SizedBox(
                    ...
                    child: Center(
                        child: Text("EVERYONE".tr().toString(),
                            style: TextStyle(
                                fontSize: 20,
                                color: eyeryone ? primaryColor : secondaryColor,
                                fontWeight: FontWeight.bold))),
                  ),
                  onPressed: () {
                    setState(() {
          ...
          men || women || eyeryone
              ? CustomButton(
                  ...
                  onTap: () {
                    if (men) {
                      context.read<ProfileCubit>().updateProfile(showMe: 'men');
                    } else if (women) {
                      context
                          .read<ProfileCubit>()
                          .updateProfile(showMe: 'women');
                    } else {
                      context
                          .read<ProfileCubit>()
                          .updateProfile(showMe: 'everyone');
                    }

                    Navigator.pushNamed(context, RouteName.profilePicSetScreen);
                  },
                  color: textColor,
                  active: true)
              : CustomButton(
