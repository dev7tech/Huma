...
class _InfoState extends State<Info> {
  ...
  void initState() {
    ...
    // context.read<StreetviewdataBloc>().add(LoadStreetViewDataEvent(user: widget.user));
    super.initState();
  }
      ...
      body: Container(
        ...
        child: Stack(
          children: <Widget>[
            SingleChildScrollView(
              child: Column(
                children: <Widget>[
                    ...
                    child: Stack(children: [
                      Swiper(
                        ...
                        itemBuilder: (BuildContext context, int idx) {
                          return widget.user.profileUrl != null
                              ? Hero(
                                  tag: "abc",
                                  child: CustomCNImage(
                                    imageUrl: widget.user.images[idx],
                                    fit: BoxFit.cover,
                                  ))
                              : Container();
                        },
                      ...
                      BlocBuilder<StreetviewdataBloc, StreetviewdataState>(
                        builder: (context, state) {
                          ...
                          if (state is StreetViewDataLoadedState) {
                            debugPrint("option is ${state.option}");
                            switch (state.option) {
                              case 'None':
                                return const SizedBox.shrink();
                    ...
                    child: Container(
                      ...
                      child: Column(
                        children: <Widget>[
                          ...
                          //           data: widget.user.sexualOrientation!['orientation'],
                          //         ))
                          //     : Container(),
                          ...
                          //         title: Text(
                          //           widget.user.editInfo!['university'].toString().trim(),
                          //           style: TextStyle(
                          //               color: secondaryColor,
                          //               fontSize: 16,
                          //               fontWeight: FontWeight.w500),
                          ...
                          //               fontWeight: FontWeight.w500),
                          //         ).tr(args: [
                          //           (widget.user.editInfo!['living_in'].toString().trim())
                          //         ]),
                          //       )
                          //     : Container(),
                          // !isMe
                  ...
                  // widget.user.editInfo!['about'] != null ? const Divider() : Container(),
                  // !isMe
                  //     ? InkWell(
                  //         onTap: () => showDialog(
                  ...
                  //                 reportedBy: widget.currentUser, reported: widget.user)),
                  //         child: SizedBox(
                  //             width: MediaQuery.of(context).size.width,
                  //             child: Center(
                  //               child: Text(
                  //                 "REPORT"
                  //                     .tr(args: ["${widget.user.name}".toUpperCase()]).toString(),
            ...
            //         ? FloatingButton(
            //             onTap: () {
            //               Navigator.pushReplacementNamed(context, RouteName.editProfileScreen);
            //             },
            //             icon: Icon(
            //               Icons.edit,
            //               color: primaryColor,
