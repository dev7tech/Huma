...
class SingleChatTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // final chatReference = db.collection("chats").doc(chatId).collection('messages');
    ...
    return Container(
      ...
      child: ListTile(
        ...
        //       return !isBlocked
        //           ? Text(
        //               chat.type == 'Image' ? "Photo" : chat.text!.replaceAll('\n', ' '),
        //               style: TextStyle(
        ...
        //                 Text(
        //                   chat.timestamp != null
        //                       ? DateFormat('dd/MM/yy').format(chat.timestamp!.toDate()).toString()
        //                       : "",
        //                   style: const TextStyle(
        //                     color: Colors.grey,
        //                     fontSize: 15.0,
